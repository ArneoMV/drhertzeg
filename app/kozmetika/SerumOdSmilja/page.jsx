...
export default function SerumodSmilja() {
  ...
  const product = productsCaj.find(p => p.id === "SerumOdSmilja");
  ...
  // Images
  const slides = [
    { src: '/images/product/kozmetika/ambalaza-SerumOdSmilja.png', title: 'Serum Od Smilja' },
  ];
          ...
          <div className="column">
            <div className="flex">
              ...
              <ReviewRight 
                ...
                userReview="Zadovoljna sam rezultatom! Serum daje mojoj koži prirodan sjaj i dubinsku njegu. Defintivno se isplati uložiti."
              />
            </div>
          </div>
        </div>
