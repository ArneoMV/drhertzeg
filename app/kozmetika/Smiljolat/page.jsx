...
export default function Smiljolat() {
  ...
  // Images
  const slides = [
    { src: '/images/product/kozmetika/ambalaza-Smiljolat.png', title: 'Smiljolat' },
  ];
          ...
          <div className="column">
            <div className="flex">
              ...
              <ReviewRight 
                ...
                userReview="Koristim Smiljolat kao prvi korak u svojoj rutini njege i primijetila sam poboljšanje u hidrataciji i općem izgledu kože."
              />
            </div>
          </div>
        </div>
