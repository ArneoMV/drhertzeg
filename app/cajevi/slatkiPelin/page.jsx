...
import SlatkiPelinSlika from "../../assets/image/product/Proizvod_Slatki_Pelin.png"


export default function slatkiPelin() {
  return (
    <main>
      <div className="productContainer">
        <div className="productImage">
          <Image 
            src={SlatkiPelinSlika}
            alt='Slatki Pelin proizvod'
            quality={100}
            width={100}
            height={100}
          />
